						...
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							...
							<nav class="main_nav_contaner">
								<ul class="main_nav">
									...
									<li class="active"><a href="{{url('/materi/show')}}">Materi</a></li>
	...
	<div class="menu d-flex flex-column align-items-end justify-content-start text-right menu_mm trans_400">
		...
		<nav class="menu_nav">
			<ul class="menu_mm">
                ...
                <li class="menu_mm"><a href="{{url('/feedback/show')}}">Ujian</a></li>
			...
			<div class="row courses_row">
				...
				<div class="col-lg-4 course_col">
					<div class="course">
						...
						<div class="course_body">
							<div class="course_title"><a href="course.html">Intro</a></div>
							<div class="course_info">
								<ul>
									<li><a href="instructors.html">Sarah Parker</a></li>
									<li><a href="#">TOEFL Preparation</a></li>
