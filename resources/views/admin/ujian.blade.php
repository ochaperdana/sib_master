			...
			<div class="row courses_row">
				...
				<div class="col-lg-4 course_col">
					<div class="course">
						...
						<div class="course_body">
							...
							<div class="course_info">
								<ul>
									<li><a href="instructors.html">Above Average</a></li>
									<li><a href="#">TOEFL Preparation</a></li>
								</ul>
							</div>
							<div class="course_text">
                ...
                <div class="col-lg-4 course_col">
					<div class="course">
						...
						<div class="course_body">
							...
							<div class="course_info">
								<ul>
									<li><a href="instructors.html">Under Average</a></li>
									<li><a href="#">TOEFL Preparation</a></li>
								</ul>
							</div>
							<div class="course_text">
				...
				<div class="col-lg-4 course_col">
					<div class="course">
						<div class="course_image"><img src="images/course_5.jpg" alt=""></div>
						<div class="course_body">
							<div class="course_title"><a href="course.html">Quarter Exam</a></div>
							<div class="course_info">
								<ul>
									<li><a href="instructors.html">Average</a></li>
									<li><a href="#">TOEFL Preparation</a></li>
								</ul>
							</div>
							<div class="course_text">
				...
				<div class="col-lg-4 course_col">
					<div class="course">
						<div class="course_image"><img src="images/course_5.jpg" alt=""></div>
						<div class="course_body">
							<div class="course_title"><a href="course.html">Finals</a></div>
							<div class="course_info">
								<ul>
									<li><a href="instructors.html">Under Average</a></li>
									<li><a href="#">TOEFL Preparation</a></li>
